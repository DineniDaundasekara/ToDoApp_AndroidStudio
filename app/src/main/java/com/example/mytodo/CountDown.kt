...
class CountDown : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main)) { v, insets ->
            val button1: Button =findViewById(R.id.button_count_1)
            button1.setOnClickListener{
                val btn1= Intent(this@CountDown,Alarm::class.java)
                startActivity(btn1)

            }

            val button2: Button =findViewById(R.id.button_count_2)
            button2.setOnClickListener{
                val btn2= Intent(this@CountDown,Home::class.java)
                startActivity(btn2)
    ...
    private fun startTimer(pauseOffSetL: Long) {
        ...
        timeCountDown = object : CountDownTimer(
            ...
            override fun onFinish() {
                resetTime()
                Toast.makeText(this@CountDown, "Times Up!", Toast.LENGTH_SHORT).show()
            }
